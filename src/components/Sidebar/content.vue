<template>
  <div :class="['st-container', state ? 'st-menu-open' : '', effect ? effect : 'st-effect' ]">

    <nav :class="['st-menu', effect  ? effect : 'st-effect' ]">
      <slot name="nav"></slot>
    </nav>
...
export default {
  ...
  methods: {
    menuEffect () {
      ...
      // console.log('self.data.effect', self.data.effect)
      // console.log('this.effect', this.effect)
